...
% Aplicar k-vecinos cercanos (KNN) a las salidas del perceptrón multicapa
knn_model = fitcknn(y_pred_nn', y_test, 'NumNeighbors', 3);  % Utiliza k=3

% Realizar predicciones con KNN
y_pred_knn = predict(knn_model, y_pred_nn');

% Calcular la matriz de confusión
confMat = confusionmat(y_test, y_pred_knn);
